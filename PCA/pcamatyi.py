# -*- coding: utf-8 -*-
"""
Created on Sun May 17 23:24:53 2020
...
fig = plt.figure(4);
plt.title('Insurance Company Benchmark');
plt.xlabel('PC1');
plt.ylabel('PC2');
...
plt.title('Magyarázott kumulatív varianciaarány diagram');
x_pos = np.arange(dim);
#plt.xticks(x_pos,x_pos+1);
plt.xlabel('Fő arányok');
plt.ylabel('Halmozott variancia');
